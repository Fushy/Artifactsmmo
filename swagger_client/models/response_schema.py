...
class ResponseSchema(object):
    ...
    def __init__(self, message=None):  # noqa: E501
        """ResponseSchema - a model defined in Swagger"""  # noqa: E501
        self._message = None
    ...
    @property
    def message(self):
        """Gets the message of this ResponseSchema.  # noqa: E501


        :return: The message of this ResponseSchema.  # noqa: E501
        :rtype: object
        """
    ...
    def message(self, message):
        ...
        :param message: The message of this ResponseSchema.  # noqa: E501
        :type: object
        """
        if message is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseSchema, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseSchema):
            return False
